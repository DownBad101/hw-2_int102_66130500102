...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        System.out.println("testString(\"Nong Far\") returns " + testString("Nong Far"));
        System.out.println("testPositive(2) returns " + testPositive(2));
        System.out.println("computeIsbn10(123456789) returns " + computeIsbn10(895746214));
       /*
    ...
    static void work03Account() {
        ...
        System.out.println("ACTION: Add 500 to all accounts");
